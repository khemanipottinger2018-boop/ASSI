...
export default function AdminErrorsPage() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/admin/errors`, { credentials: 'include' })
      .then(r => r.json())
      .then(setData)
      .catch(() => setData({ success: false, error: 'Failed to load errors' }));
  }, []);

  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      <SectionLabel text="Errors // Diagnostics" />
      <Panel>
...
// same helpers as sessions page (copy/paste)
