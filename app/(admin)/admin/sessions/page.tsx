...
import {
  Activity, RefreshCw, Loader2, XCircle,
...
const STATUS_CONFIG: Record<SessionStatus, {
  ...
  waiting: {
    dot: '#facc15', dotGlow: '0 0 8px rgba(250,204,21,0.8)',
    label: 'WAITING',  labelColor: 'rgba(250,204,21,0.85)',
    rowBorder: 'rgba(250,204,21,0.1)',
  },
  active: {
    dot: '#34d399', dotGlow: '0 0 8px rgba(52,211,153,0.8)',
    label: 'ACTIVE',   labelColor: 'rgba(52,211,153,0.85)',
    rowBorder: 'rgba(52,211,153,0.12)',
  },
  paused: {
    dot: '#fb923c', dotGlow: '0 0 8px rgba(251,146,60,0.7)',
    label: 'PAUSED',   labelColor: 'rgba(251,146,60,0.85)',
    rowBorder: 'rgba(251,146,60,0.1)',
  },
  ended: {
    dot: 'rgba(255,255,255,0.2)', dotGlow: 'none',
    label: 'ENDED',    labelColor: 'rgba(255,255,255,0.25)',
...
export default function AdminSessionsPage() {
  ...
  async function forceEnd(sessionId: string, e: React.MouseEvent) {
    ...
    try {
      await fetch(`${API_URL}/api/admin/sessions/${sessionId}/end`, {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, fontFamily: "'DM Mono', 'Fira Code', monospace" }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <p style={{ color: 'rgba(52,211,153,0.5)', fontSize: 9, letterSpacing: '0.25em', textTransform: 'uppercase' }}>
              Session Monitor
            </p>
            <p style={{ color: 'rgba(200,240,220,0.75)', fontSize: 14, marginTop: 2, fontWeight: 600 }}>
              Live Sessions
            </p>
          </div>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10 }}>
        {[
          ...
          <div key={label} style={{
            ...
            background: 'rgba(0,10,22,0.75)', border: `1px solid ${color}22`,
            ...
            <p style={{ marginTop: 8, fontSize: 28, fontWeight: 700, color, lineHeight: 1,
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      gap: 14, padding: '12px 16px', cursor: 'pointer',
                  ...
                  >
                    ...
                    <span style={{
                      ...
                      background: cfg.dot, boxShadow: cfg.dotGlow,
                    }} />
                    ...
                    <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '120px 90px 100px 80px 80px 1fr', gap: 8, alignItems: 'center', minWidth: 0 }}>
                      ...
                      <div>
                        ...
                        <p style={{ color: 'rgba(180,220,255,0.7)', fontSize: 11, fontFamily: 'inherit' }}>
                      ...
                      <div>
                        ...
                        <p style={{ color: 'rgba(200,230,255,0.55)', fontSize: 11 }}>
                          {session.subjectName ?? '—'}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                          ...
                          <p style={{ color: 'rgba(200,230,255,0.55)', fontSize: 11, fontVariantNumeric: 'tabular-nums' }}>
                      ...
                      {session.status !== 'ended' && (
                        <button
                          ...
                          style={{
                            ...
                            cursor: endingId ? 'default' : 'pointer',
                            opacity: endingId && !isEnding ? 0.3 : 1,
                            transition: 'all 0.15s ease',
                          }}
                        >
                          {isEnding
                      ...
                      >
                        <div style={{
                          ...
                          {[
                            ...
                            { label: 'Messages',    value: session.messageCount != null ? String(session.messageCount) : '—' },
                          ].map(({ label, value }) => (
                            <div key={label}>
                              <p style={{ color: 'rgba(0,180,255,0.3)', fontSize: 8, letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: 4 }}>{label}</p>
                              <p style={{ color: 'rgba(180,220,255,0.6)', fontSize: 11, fontFamily: 'inherit', wordBreak: 'break-all' }}>{value}</p>
                            </div>
                          ))}
                        </div>
                      </motion.div>
