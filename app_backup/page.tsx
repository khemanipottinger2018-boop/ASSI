          ...
          >
            <div className="text-xs space-y-1">
              <div className="flex items-center space-x-2">
                ...
                <span>{stats.onlineTutors} tutors online</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                <span>{stats.totalTutors} total tutors</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                <span>{stats.availableSubjects} subjects</span>
              </div>
            </div>
          </motion.div>
        )}
              ...
              {!isLoading && (
                ...
                >
                  <p className="text-sm mb-4">
                    Join <span className="text-green-400 font-semibold">{stats.totalTutors}+ tutors</span> and thousands of students learning right now
                  </p>
                  <div className="mt-4 flex justify-center space-x-4 text-xs">
                    <div className="flex items-center">
                      <span className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></span>
                      {stats.onlineTutors} Online Now
                    </div>
                    <div className="flex items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      {stats.availableSubjects} Subjects
                    </div>
                  </div>
                </motion.div>
              )}
